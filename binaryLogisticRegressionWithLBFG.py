...
from influence.logisticRegressionWithLBFG import LogisticRegressionWithLBFG

class BinaryLogisticRegressionWithLBFG(LogisticRegressionWithLBFG):

    def __init__(self, **kwargs):

        super(BinaryLogisticRegressionWithLBFG, self).__init__(**kwargs)
    ...
    def get_loo_influences(self):
        ...
        print("theta = self.sess.run(self.params)[0]")
        print(theta)
        ...
        print("shape of x_train_theta")
        print(x_train_theta.shape)
